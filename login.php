            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
						...
						<button class="btn btn-secondary" type="button" onclick="login(0)" id="loginbutton">Σύνδεση</button>
						<button class="btn btn-secondary" type="button" onclick="login(1)">Εγγραφή</button>
						</div>
				</div>
                    </div>
                </div>
